...
-- Copiando estrutura para tabela gkcontrol.adm_user
CREATE TABLE IF NOT EXISTS `adm_user` (
  `adm_user_id` int(11) NOT NULL AUTO_INCREMENT,
  `adm_user_name` varchar(255) DEFAULT NULL,
  `adm_user_lastname` varchar(255) DEFAULT NULL,
  `adm_user_email` varchar(255) DEFAULT NULL,
  `adm_user_pass` varchar(255) DEFAULT NULL,
  `adm_user_level` varchar(255) DEFAULT NULL,
  `adm_user_permissions` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`adm_user_permissions`)),
  `adm_user_ip` varchar(50) DEFAULT NULL,
  `adm_user_created_at` timestamp NULL DEFAULT current_timestamp(),
  `adm_user_update_at` timestamp NULL DEFAULT NULL ON UPDATE current_timestamp(),
  PRIMARY KEY (`adm_user_id`),
  UNIQUE KEY `adm_user_email` (`adm_user_email`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COMMENT='Tabela usuários do painel';

-- Copiando dados para a tabela gkcontrol.adm_user: ~2 rows (aproximadamente)
/*!40000 ALTER TABLE `adm_user` DISABLE KEYS */;
INSERT IGNORE INTO `adm_user` (`adm_user_id`, `adm_user_name`, `adm_user_lastname`, `adm_user_email`, `adm_user_pass`, `adm_user_level`, `adm_user_permissions`, `adm_user_ip`, `adm_user_created_at`, `adm_user_update_at`) VALUES
	(1, 'Guilherme', 'K Fagundes', 'guilhermekfagundes259@gmail.com', '$2y$10$/4U94GCAWrSc4WGBtjzAYejwIw5exFWzCAl7wJJheEbH07/HQSXoe', 'Administrador', NULL, '::1', '2020-07-07 18:19:35', '2020-07-13 19:36:23'),
	(11, 'Guilherme', 'Konflanz', 'guilhermekonflanz94@outlook.com', '$2y$10$YMgWAf.8pSSWOZ1RT/J3S.n.g4LAHnWdEDif5onaCWtz94awhNiei', 'Administrador', NULL, NULL, '2020-07-18 17:04:30', NULL);
/*!40000 ALTER TABLE `adm_user` ENABLE KEYS */;

-- Copiando estrutura para tabela gkcontrol.app_cidade
CREATE TABLE IF NOT EXISTS `app_cidade` (
  `cod_municipio` bigint(20) NOT NULL AUTO_INCREMENT,
  `nome` varchar(100) NOT NULL,
  `cod_estado` bigint(20) NOT NULL,
  PRIMARY KEY (`cod_municipio`),
  KEY `fk_tab_municipio_tab_estado` (`cod_estado`),
  CONSTRAINT `fk_tab_municipio_tab_estado` FOREIGN KEY (`cod_estado`) REFERENCES `app_estado` (`cod_estado`)
) ENGINE=InnoDB AUTO_INCREMENT=4305440 DEFAULT CHARSET=utf8;

-- Copiando dados para a tabela gkcontrol.app_cidade: ~4.713 rows (aproximadamente)
/*!40000 ALTER TABLE `app_cidade` DISABLE KEYS */;
INSERT IGNORE INTO `app_cidade` (`cod_municipio`, `nome`, `cod_estado`) VALUES
...
-- Copiando estrutura para tabela gkcontrol.app_estado
...
-- Copiando dados para a tabela gkcontrol.app_estado: ~27 rows (aproximadamente)
/*!40000 ALTER TABLE `app_estado` DISABLE KEYS */;
INSERT IGNORE INTO `app_estado` (`cod_estado`, `sigla`, `nome`) VALUES
	(11, 'RO', 'Rondônia'),
	(12, 'AC', 'Acre'),
	(13, 'AM', 'Amazonas'),
	(14, 'RR', 'Roraima'),
...
-- Copiando estrutura para tabela gkcontrol.config_level
CREATE TABLE IF NOT EXISTS `config_level` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `config_level` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COMMENT='Configurações de nivel de acesso';

-- Copiando dados para a tabela gkcontrol.config_level: ~2 rows (aproximadamente)
/*!40000 ALTER TABLE `config_level` DISABLE KEYS */;
INSERT IGNORE INTO `config_level` (`id`, `config_level`) VALUES
	(1, 'Administrador'),
	(2, 'Comum');
/*!40000 ALTER TABLE `config_level` ENABLE KEYS */;
